...
from utils.myplots import plot_images, plot_labels, plot_results, plot_evolution
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            if 1:
                with open("targets.txt", 'a') as f:
                    print(f"epoch:{epoch}, i:{i}, targets:{targets.shape}, imgs:{imgs.shape}", file=f)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default=r'models/myyolov5s_2.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/woodstest2.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=50)
    parser.add_argument('--batch-size', type=int, default=15, help='total batch size for all GPUs')
