...
class Anchor_Generator:
    def __init__(self, basedir, whsavepath, yamlpath=None, maxnum=5000, iouthresh = 0.2):
        ...
        if self.whsavepath.exists():
            ...
            labeldict = {x.stem: self.getlabelinfo(x) for x in labelfilelist if len(self.getlabelinfo(x)) > 0}
...
if __name__ == '__main__':
    ...
    #     whsavepath.unlink()
    ag = Anchor_Generator(basedir, whsavepath, yamlpath, maxnum=5000,iouthresh=iouthresh)
    anchor = ag()
    print(anchor)
